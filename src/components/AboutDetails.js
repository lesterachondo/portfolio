  ...
  return (
    <>
      <div className='aboutContent'>
        <h2>So, who am I?</h2>
        <p>
          I’m Lester, a full-stack web developer with expertise in both front-end and back-end development. My career began when I earned a Bachelor of Science in Computer Science from the University of Caloocan City, where I gained skills in both hardware and software.
        </p>
        <p>
        ...
        <p>
          I’m always looking for new challenges and opportunities to grow as a developer, and I’m excited to continue building applications that make a meaningful impact.
        </p>
      </div>
    </>
  )
